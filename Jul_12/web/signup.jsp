...
<div class="container" style="width: 400px;">
    ...
    <form action="${pageContext.request.contextPath}/signupServlet" method="post">
        ...
        <div class="form-group" style="text-align: center">
            <input style="margin-left: 2px" class="btn btn-primary" type="submit" value="Submit"/>
            <input class="btn btn-default" style="margin-right: 20px; margin-left: 20px" type="reset" value="Reset"/>
            <a href="${pageContext.request.contextPath}/login.jsp" style="margin-right: 2px" class="btn btn-default">Back</a>
        </div>
    </form>
